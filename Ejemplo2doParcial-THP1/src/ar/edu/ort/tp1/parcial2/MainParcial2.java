	...
	private void estacionarMotos(Estacionamiento e) {
		...
		for (VehiculoDTO vehiculoDTO : motos) {
			try {
				...
				System.out.println("Se estacionó correctamente la motocicleta patente: " + vehiculoDTO.getPatente());
			} catch (Exception ex) {
				System.out.println("No se pudo estacionar el vehículo - " + ex.getMessage());
			}
	...
	private void estacionarAutos(Estacionamiento e) {
		...
		for (VehiculoDTO vehiculoDTO : autos) {
			try {
				...
				System.out.println("Se estacionó correctamente el auto patente: " + vehiculoDTO.getPatente());
			} catch (Exception ex) {
				System.out.println("No se pudo estacionar el vehículo - " + ex.getMessage());
			}
	...
	private void retirarAutos(Estacionamiento e) {
		...
		for (VehiculoDTO vehiculoDTO : autos) {
			...
			try {
				...
				System.out.println("No se pudo estacionar el vehículo - " + e2.getMessage());			}
	...
	private void retirarMotos(Estacionamiento e) {
		...
		for (VehiculoDTO vehiculoDTO : motos) {
			...
			try {
				...
				System.out.println("No se pudo estacionar el vehículo - " + e3.getMessage());			}
