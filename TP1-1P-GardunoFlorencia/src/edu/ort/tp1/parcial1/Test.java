...
public class Test {
	...
	public static void main(String[] args) {
		...
		// System.out.println("Cosechas de " + Producto.MANZANA + " en la
		// Plantacion 1:");
		// System.out.println(laFrutera.cosechasDePlantacionYProducto(1,
		// Producto.MANZANA));

		// System.out.println("--------------------------------------------");
		// Obtener las toneladas consechadas de Limon en la Plantacion 2 y
		// mostrarla por pantalla
		System.out.println("Toneladas de " + Producto.LIMON + " en la Plantacion 2:");
