...
public class Auto {
	...
	//La clase Auto tiene una relacion de agregacion con la clase Pasajero
	private ArrayList<Pasajero> pasajeros;
	
	/*
	 * Como la relacion es de agregacion, el o los pasajeros no son requeridos para la creacion
	 * de un objeto Auto.
	 */
