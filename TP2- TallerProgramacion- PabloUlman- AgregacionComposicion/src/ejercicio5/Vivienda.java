...
public class Vivienda {
	...
	public void mostrarTodo () {
		...
		System.out.println("Direccion: " + this.direccion.getCalle() + " " + this.direccion.getAltura()+ " "+  this.direccion.getPiso()+ " " + this.direccion.getDepartamento());
	...
	public String getDepartamento() {
		return this.getDireccion().getDepartamento();
	}


	public int getPiso() {
		return this.getDireccion().getPiso();
	}
	
	
	public void vaciarVivienda () {
		this.inquilinos.removeAll(inquilinos);
		this.muebles.removeAll(muebles);
	}
