...
public class Club {
	...
	/*
	 * En la clase ClubSocial desarrolla un m�todo, montoAbonar 1. Recibe un dni 2.
	...
	/*
	 * La explotaci�n del m�todo 
(...) de ClubSocial, que
	 * recibe el n�mero de DNI de un socio y el nombre de una actividad. El m�todo
	 * debe controlar que tanto el socio como la actividad sean v�lidos. Adem�s de
	 * agregar �cuando sea posible� la actividad a las que el socio ya realiza, el
	 * m�todo debe devolver un mensaje que indicar� el resultado de la operaci�n: 1.
	 * �El socio fue inscripto en la actividad�. 2. �El socio ya realiza esta
	 * actividad�. 3. �El socio no puede hacer m�s actividades pues su cupo de
	 * actividades est� cubierto�. 4. �El socio tiene una deuda pendiente�. 5. �El
	...
	public String inscribirSocioEnActividad(String dni, String nombreAct) {
		...
		case 2:
			...
			break;
		case 3:
			mostrar = "El socio no puede hacer m�s actividades pues su cupo de actividades est� cubierto";
			break;
		case 4:
	...
	public int inscipcionSocioAct(String dni, String nombreAct) {
		...
		if (act != null) {
			...
			resultado = 3; // 3. �El socio no puede hacer m�s actividades pues su cupo de actividades est�
							// cubierto�.
